...
template <> const char * mrpt::utils::CSerializer<CSetOfLines>::getClassName() { return "CSetOfLines";}
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
template <> void CSerializer<CSetOfLines>::writeToStream(const CSetOfLines& o, mrpt::utils::CStream &out,int *version)
{
