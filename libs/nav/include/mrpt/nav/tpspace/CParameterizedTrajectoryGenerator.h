...
protected:
	...
	class TListPTGs : public std::vector<mrpt::nav::CParameterizedTrajectoryGenerator*>      //!< A list of PTGs (bare pointers)
	{
	public:
		using std::vector<mrpt::nav::CParameterizedTrajectoryGenerator*>::vector;
		using Ptr = std::shared_ptr<TListPTGs>;
	};
