...
namespace mrpt
{
  namespace nav
  {
	 ...
	 *  \ingroup nav_tpspace
	 */
	class NAV_IMPEXP  CPTG_DiffDrive_alpha : public mrpt::utils::CSerializableCRTP<CPTG_DiffDrive_alpha, CPTG_DiffDrive_CollisionGridBased, CParameterizedTrajectoryGenerator>
	{
