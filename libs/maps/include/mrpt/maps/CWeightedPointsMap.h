...
namespace mrpt
{
	namespace maps
	{
		 ...
		 */
		class MAPS_IMPEXP CWeightedPointsMap : public mrpt::utils::CSerializableCRTP<CWeightedPointsMap, CPointsMap>
		{
			friend mrpt::utils::CSerializer<CWeightedPointsMap>;
