...
namespace mrpt
{
	...
	namespace hmtslam
	{
		...
		protected:
			...
			typedef std::shared_ptr<TMessageLSLAMfromAA> TMessageLSLAMfromAA::Ptr;
			...
			typedef std::shared_ptr<TMessageLSLAMtoTBI> TMessageLSLAMtoTBI::Ptr;
			...
			typedef std::shared_ptr<TMessageLSLAMfromTBI>	TMessageLSLAMfromTBI::Ptr;
