...
namespace obs
{
	...
	class OBS_IMPEXP CObservationBearingRange : public mrpt::utils::CSerializableCRTP<CObservationBearingRange, CObservation>
	{
	 ...
	 public:
		...
		// See base class docs
		void getSensorPose( mrpt::poses::CPose3D &out_sensorPose ) const override { out_sensorPose = sensorLocationOnRobot; }
		void setSensorPose( const mrpt::poses::CPose3D &newSensorPose ) override { sensorLocationOnRobot = newSensorPose; }
