...
namespace obs
{
	 ...
	 * \ingroup mrpt_obs_grp
	  */
	class OBS_IMPEXP CObservationStereoImages : public mrpt::utils::CSerializableCRTP<CObservationStereoImages, CObservation>
	{
		friend mrpt::utils::CSerializer<CObservationStereoImages>;
