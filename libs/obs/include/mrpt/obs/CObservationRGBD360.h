...
//	}
	 ...
	 */
	class OBS_IMPEXP CObservationRGBD360 : public mrpt::utils::CSerializableCRTP<CObservationRGBD360, CObservation>
	{
		friend mrpt::utils::CSerializer<CObservationRGBD360>;
