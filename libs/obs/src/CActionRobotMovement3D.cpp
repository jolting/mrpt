...
/*---------------------------------------------------------------
 ...
 ---------------------------------------------------------------*/
template <> void CSerializer<CActionRobotMovement3D>::readFromStream(CActionRobotMovement3D& o, mrpt::utils::CStream &in, int version)
{
	switch(version)
	{
	case 0:
	...
	)
{
	...
	mrpt::poses::CPose3DPDF::Ptr poseChangeTemp = std::make_shared<CPose3DPDFParticles>();
