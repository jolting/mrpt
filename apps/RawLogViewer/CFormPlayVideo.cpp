...
void CFormPlayVideo::OnbtnPlayClick(wxCommandEvent& event)
{
    ...
    try
    {
        ...
        while (m_nowPlaying)
        {
            ...
            {
            	CSensoryFrame	sf;
            	sf.insert( CObservation::Ptr(obj) );
...
void CFormPlayVideo::saveCamImage(int n)
{
	...
	{
		CObservationImage::Ptr o = CObservationImage::Ptr( displayedImgs[n]);
	...
	{
		CObservationStereoImages::Ptr o = CObservationStereoImages::Ptr( displayedImgs[n]);
