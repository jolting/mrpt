		...
		case CRawlog::etSensoryFrame:
			{
				...
				for (CSensoryFrame::iterator it=sf->begin();it!=sf->end();++it)
				{
					...
					{
						CObservationGPS::Ptr obs = CObservationGPS::Ptr(*it);
        ...
        case CRawlog::etObservation:
            {
				...
				{
					CObservationGPS::Ptr obs = CObservationGPS::Ptr(o);
					fixGPStimestamp(obs, time_changes, DeltaTimes);
				}
            }
            break;
        ...
        case CRawlog::etSensoryFrame:
            {
                ...
                if (o1)
                {
                    ...
                    CObservationGPS::Ptr obs = CObservationGPS::Ptr(o1);
                ...
                if (o2)
                {
                    ...
                    CObservationGPS::Ptr obs = CObservationGPS::Ptr(o2);
                    if (obs->has_GGA_datum && obs->getMsgByClass<gnss::Message_NMEA_GGA>().fields.fix_quality==4)
                        last_GPS2 = obs;
                }
            }
        ...
        case CRawlog::etObservation:
            {
                ...
                {
                	CObservationGPS::Ptr ob = CObservationGPS::Ptr(o);
    ...
    int &changesCount  )
{
    if (SF)
    {
        for (CSensoryFrame::iterator it=SF->begin();it!=SF->end();  )
        {
            ...
            {
            	CObservationGPS::Ptr o = CObservationGPS::Ptr(*it);
            	if (o->has_GGA_datum &&
